            ...
            $('h1').click(function() {
                ...
                $(this).next('#k').slideDown('fast');
					...
					$("#divResult").fadeIn(2000,function()
							...
							$("#divResult2").html("<p>♥ ỪA THÌ ANH BIẾT ANH ĐẸP TRAI THẬT. NHƯNG THÔI ANH CŨNG ĐÀNH CHỊU THIỆT YÊU EM VẬY .<img src='http://website1gia.com/files/assets/4.png'/></p></br>");
							$("#divResult2").fadeIn(2000,function()
									{
									$("#divResult3").fadeOut(0);
									$("#divResult3").html("<p>VẬY HÃY ĐỂ TRÁI TIM ANH THUỘC VỀ EM MỘT LẦN NHÉ!  <img src='http://website1gia.com/files/assets/5.png'/></p></br>");
